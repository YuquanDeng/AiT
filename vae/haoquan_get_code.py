...
# /data/input/jiafei/datasets/Full_OXE/pose/bc_z/0000000/0000.png
# /data/input/jiafei/datasets/Full_OXE/pose/bridge_dataset/0000000/0000.png
# /data/input/jiafei/datasets/Full_OXE/pose/fractal20220817_data/0000000/0000.png

# val_dataset = CustomDataset(data_path='/gscratch/krishna/mahtab/syntheic_data/Depth-Anything/ADE_depth/', crop_size=(image_size, image_size))
# val_dataset = CustomDataset(data_path='/gscratch/krishna/mahtab/syntheic_data/Depth-Anything/COCO_depth/', crop_size=(image_size, image_size))
